...
# the stateless MhcFusedHcRunner dispatch object on every call; output and
# workspace storage remains per-call so its lifetime follows the caller or
# CUDA graph that owns it.
